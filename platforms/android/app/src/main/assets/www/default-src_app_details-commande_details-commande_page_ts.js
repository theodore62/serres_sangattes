(self["webpackChunkserres_sangatte"] = self["webpackChunkserres_sangatte"] || []).push([["default-src_app_details-commande_details-commande_page_ts"],{
...
let DetailsCommandePage = class DetailsCommandePage {
    constructor(commandeService, clientService, plantesService, firestore, toastCtrl, formBuilder, modalController, alertController, actionCtrl, platform) {
        ...
        this.commandeService
            ...
            this.details.forEach((index) => {
                ...
                if (inforComplementaire != null && date != null && client != null) {
                    ...
                    date.setAttribute('value', (0,_angular_common__WEBPACK_IMPORTED_MODULE_7__.formatDate)(index.date, 'yyyy-MM-dd', 'en-US'));
                }
            });
        });
        this.initializeItems();
        this.formulaireCommande = this.formBuilder.group({
            client: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required]],
            date: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required]],
            infoComplementaire: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required]],
        });
    }
    loadMap() {
    ...
    update() {
        this.firestore.doc(`Commandes/${this.idCommande}`).set({
            id: this.idCommande,
            liste: this.tableau,
            date: (0,_angular_common__WEBPACK_IMPORTED_MODULE_7__.formatDate)(this.formulaireCommande.value.date, 'dd/MM/yyyy', 'fr-FR'),
...
DetailsCommandePage.propDecorators = {
    idCommande: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_12__.Input }],
    idClient: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_12__.Input }]
};
DetailsCommandePage = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("ion-header {\n  --ion-background-color: #3366a0;\n}\n\nion-content {\n  color: #fff;\n  --ion-background-color: linear-gradient(#3366a0, #9eb7d2);\n}\n\nion-button {\n  --background: #6c91bb;\n}\n\nion-title, ion-icon {\n  color: #fff;\n}\n\nion-item, ion-list, ion-item-options, ion-item-option {\n  --ion-background-color: transparent !important;\n}\n\n.titreAjouter {\n  text-align: center;\n  size: 40%;\n}\n\n#map_canvas {\n  width: 100%;\n  height: 30%;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
//# sourceMappingURL=default-src_app_details-commande_details-commande_page_ts.js.map